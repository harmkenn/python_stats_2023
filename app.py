...
from apps import 1_quant, discrete, normal, proportions, studentt, allttests, chisquare, linearregression, anova # import your app modules here
st.set_page_config(layout="wide")
app = MultiApp()

# Add all your application here
app.add_app("Quantitative Stats", 1_quant.app)
